...
document.cookie = name + "=1 ; expires=Fri, 31 Dec 1984 23:59:59 GMT;";
}
}
...
stTransform(!t);
document.getElementById("AsaiGB").innerHTML = t?"繁體中文":"简体中文";
}
if(Cookie.Get("l") == "t")
setTimeout(function(){stTransform(true);document.getElementById("AsaiGB").innerHTML = "简体中文";},100);