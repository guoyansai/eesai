<!--#include file="../../../AsaiData/cf1.asp"--><!--#include file="../../inc.asp"--><%
' 功能：支付宝服务器异步通知页面
' 版本：3.3
' 日期：2012-07-17
' 说明：
...
if sVerifyResult then	'验证成功
	...
	If Request.Form("trade_status") = "TRADE_FINISHED" Then
		...
		Call zffan(out_trade_no,trade_no,2)
	...
	ElseIf Request.Form("trade_status") = "TRADE_SUCCESS" Then
		...
		Call zffan(out_trade_no,trade_no,1)
		Response.Write "success"	'请不要修改或删除
	...
	Else
		...
		Call zffan(out_trade_no,trade_no,0)
