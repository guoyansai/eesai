<!--#include file="../../AsaiData/cf.asp"--><!--#include file="../inc.asp"--><html>
<head>
...
If sVerifyResult Then	'验证成功
	...
	Call zffan(Request("out_trade_no"),Request("trade_no"),10)
    ...
    'response.Write Request("out_trade_no")&"111验证失败"&out_trade_no&"ddddddd"&trade_status&Request.QueryString
Call zffan(Request("out_trade_no"),Request("trade_no"),10)
end if
%>
