...
<div class=g-ll><ul>
<li class=g-ll0>①将网站拷贝到文件夹【<%=replace(server.mappath(Request.ServerVariables("SCRIPT_NAME")),"www.eesai.com.asp","")%>】里面，<a href="http://<%=Request.ServerVariables("HTTP_HOST")%>">点击这里打开网站</a></li>
...
<li class=g-ll0>③调试可用端口：<a href="http://127.0.0.1:7777">7777</a>,<a href="http://127.0.0.1:777">777</a>,<a href="http://127.0.0.1:77">77</a>,<a href="http://127.0.0.1:7">7</a>，例如：<a href="http://<%=Request.ServerVariables("HTTP_HOST")%>">http://<%=Request.ServerVariables("HTTP_HOST")%></a></li>
...
<li class=g-ll0>⑤网站编码为GB2312，请点击<a href="http://<%=Request.ServerVariables("HTTP_HOST")%>/www.eesai.com_gb.asp">http://<%=Request.ServerVariables("HTTP_HOST")%>/www.eesai.com_gb.asp</a>跳转到GB2312编码的文件管理系统</li>
</ul></div>
